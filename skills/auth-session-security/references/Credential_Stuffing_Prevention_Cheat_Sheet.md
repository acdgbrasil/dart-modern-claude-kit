...
[ OWASP/CheatSheetSeries  ](https://github.com/OWASP/CheatSheetSeries "Go to repository")
  ...
  * Cheatsheets  Cheatsheets 
    ...
    * Credential Stuffing Prevention  [ Credential Stuffing Prevention  ](Credential_Stuffing_Prevention_Cheat_Sheet.html) Table of contents 
      * Introduction 
...
As well as requiring a user to enter their password when authenticating, users can also be prompted to provide additional security information such as:
  ...
  * Answers to [security questions](Choosing_and_Using_Security_Questions_Cheat_Sheet.html)
...
Multi-step login processes, however, should be mindful that they do not faciliate [user enumeration](Authentication_Cheat_Sheet.html). Enumerating users prior to a credential stuffing attack may result in a harder to identify, lower request volume attack.
