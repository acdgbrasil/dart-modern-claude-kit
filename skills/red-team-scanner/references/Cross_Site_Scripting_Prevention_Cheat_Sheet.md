...
[ OWASP/CheatSheetSeries  ](https://github.com/OWASP/CheatSheetSeries "Go to repository")
  ...
  * Cheatsheets  Cheatsheets 
    ...
    * Cross Site Scripting Prevention  [ Cross Site Scripting Prevention  ](Cross_Site_Scripting_Prevention_Cheat_Sheet.html) Table of contents 
      * Introduction 
      * Framework Security 
...
Data Type: String Context: DOM XSS Code: `<script>document.write("UNTRUSTED INPUT: " + document.location.hash );<script/>` Sample Defense: [DOM based XSS Prevention Cheat Sheet](DOM_based_XSS_Prevention_Cheat_Sheet.html) |
